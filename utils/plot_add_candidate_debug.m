function plot_add_candidate_debug(keypoint_database,matched_points,prev_image,image,validity,inlier_mask,angles)
figure(10)
...
imshow(image)
hold on
t2 = matched_points(validity,:)';
t3 = t2(:,angles>pi*3/180);
scatter(t3(2,:),t3(1,:),'r');
hold off
