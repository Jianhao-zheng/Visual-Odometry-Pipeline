...
cfigs = struct('SURF',     struct('func', @detectSURFFeatures,     'params', {{'MetricThreshold', 10}}, 'support_version', 'R2011b (7.13)'),...
               'Harris',   struct('func', @detectHarrisFeatures,   'params', {{'MinQuality',1e-6}}, 'support_version', 'R2013a (8.1)'),...
